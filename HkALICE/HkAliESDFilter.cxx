...
HkAliESDFilter::HkAliESDFilter() // All data members should be initialised here
   :AliAnalysisTaskSE(),
    fOutput(0),
    fTrackCuts(0),
    fHistPt(0),
...
//________________________________________________________________________
HkAliESDFilter::HkAliESDFilter(const char *name) // All data members should be initialised here
...
void HkAliESDFilter::Terminate(Option_t *) 
{
    ...
    TCanvas *c = new TCanvas("HkAliESDFilter","P_{T}",10,10,1020,510);
    c->Divide(2,1);
    c->cd(1);
